                     ...
                     _In_ int       nCmdShow)
{
    ...
    while (TRUE)
    {
        ...
        //if (true)
        {
            ...
            pToolApp->PreviousTick(fTimer60);
            pToolApp->Tick(fTimer60);
            pToolApp->LateTick(fTimer60);
            pToolApp->Render();
    ...
    if (Safe_Release(pToolApp))
        MSG_BOX(TEXT("Failed to Released : CToolApp"));
