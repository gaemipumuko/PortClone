...
CStaff_Ice::CStaff_Ice(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
    : CPart_Weapon(pDevice, pContext)
{
}

CStaff_Ice::CStaff_Ice(const CStaff_Ice& rhs)
    : CPart_Weapon(rhs)
{
}

_matrix CStaff_Ice::Get_CombinedMatrix()
{
	return _matrix();
}

HRESULT CStaff_Ice::Invalidate_Animation(_float fTimeDelta)
{
	return S_OK;
}

void CStaff_Ice::Release_ColliderID()
{
	m_pGameInstance->Release_Collider_Object(COLL_MONSTER_WEAPON, m_iColliderID);
}

HRESULT CStaff_Ice::Initialize_Prototype()
{
...
HRESULT CStaff_Ice::Initialize_Clone(void* pArg)
{
...
HRESULT CStaff_Ice::PreviousTick(_float fTimeDelta)
{
...
HRESULT CStaff_Ice::Tick(_float fTimeDelta)
{
...
HRESULT CStaff_Ice::LateTick(_float fTimeDelta)
{
...
CStaff_Ice* CStaff_Ice::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CStaff_Ice* pInstance = new CStaff_Ice(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Create : CStaff_Ice"));
...
CGameObject* CStaff_Ice::Clone(void* pArg)
{
	CStaff_Ice* pInstance = new CStaff_Ice(*this);

	if (FAILED(pInstance->Initialize_Clone(pArg)))
	{
		MSG_BOX(TEXT("Failed to Clone : CStaff_Ice"));
		Safe_Release(pInstance);
	}
