...
#define CURRENT_LEVEL LEVEL_TEMPLE_LION

CLevel_Temple_Lion::CLevel_Temple_Lion(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CLevel(pDevice, pContext)
{
}

HRESULT CLevel_Temple_Lion::Ready_Level()
{
	...
	if (FAILED(Ready_Layer_Temple(TEXT("Layer_Temple"))))
		return E_FAIL;
...
HRESULT CLevel_Temple_Lion::Ready_Lights()
{
	if (nullptr == m_pGameInstance)
		return E_FAIL;
...
HRESULT CLevel_Temple_Lion::Ready_ConstantBuffer()
{
...
HRESULT CLevel_Temple_Lion::Ready_ParticleManager()
{
	if (nullptr == m_pGameInstance)
		return E_FAIL;
...
HRESULT CLevel_Temple_Lion::Ready_Layer_Camera(const wstring& strLayerTag)
{
	if (nullptr == m_pGameInstance)
		return E_FAIL;
...
HRESULT CLevel_Temple_Lion::Ready_Layer_Temple(const wstring& strLayerTag)
{
	if (nullptr == m_pGameInstance)
		return E_FAIL;
...
HRESULT CLevel_Temple_Lion::Ready_Layer_Player(const wstring& strLayerTag)
{
	if (nullptr == m_pGameInstance)
		return E_FAIL;
...
HRESULT CLevel_Temple_Lion::Ready_Layer_Monster(const wstring& strLayerTag)
{
	if (nullptr == m_pGameInstance)
		return E_FAIL;
...
HRESULT CLevel_Temple_Lion::Ready_Layer_EventCollider(const wstring& strLayerTag)
{
	if (nullptr == m_pGameInstance)
		return E_FAIL;
...
HRESULT CLevel_Temple_Lion::Ready_Layer_NPC(const wstring& strLayerTag)
{
	if (nullptr == m_pGameInstance)
		return E_FAIL;
...
HRESULT CLevel_Temple_Lion::Ready_Layer_Icon(const wstring& strLayerTag)
{
	if (nullptr == m_pGameInstance)
		return E_FAIL;
...
HRESULT CLevel_Temple_Lion::Ready_Layer_UI(const wstring& strLayerTag)
{
	if (nullptr == m_pGameInstance)
		return E_FAIL;
...
HRESULT CLevel_Temple_Lion::Initialize()
{
...
HRESULT CLevel_Temple_Lion::PreviousTick(_float fTimeDelta)
{
...
HRESULT CLevel_Temple_Lion::Tick(_float fTimeDelta)
{
...
HRESULT CLevel_Temple_Lion::LateTick(_float fTimeDelta)
{
...
HRESULT CLevel_Temple_Lion::Render()
{
...
CLevel_Temple_Lion* CLevel_Temple_Lion::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CLevel_Temple_Lion* pLevel = new CLevel_Temple_Lion(pDevice, pContext);

	if (FAILED(pLevel->Initialize()))
	{
		MSG_BOX(TEXT("Failed to Create : CLevel_Temple_Lion"));
		Safe_Release(pLevel);
	}
