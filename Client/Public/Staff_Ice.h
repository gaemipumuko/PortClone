...
class CStaff_Ice final : public CPart_Weapon
{
private:
	CStaff_Ice(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CStaff_Ice(const CStaff_Ice& rhs);
	virtual ~CStaff_Ice() = default;
...
public:
	static CStaff_Ice*	Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
