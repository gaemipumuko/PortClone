...
class CLevel_Quest final : public CLevel
{
private:
	CLevel_Quest(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	virtual ~CLevel_Quest() = default;
...
private:
	...
	HRESULT Ready_Layer_Quest(const wstring& strLayerTag);
...
public:
	static CLevel_Quest* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
