...
class CStaff_Water final : public CPart_Weapon
{
private:
	CStaff_Water(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CStaff_Water(const CStaff_Water& rhs);
	virtual ~CStaff_Water() = default;
...
public:
	static CStaff_Water*	Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
