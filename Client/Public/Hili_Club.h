...
class CHili_Club final : public CPart_Weapon
{
private:
	CHili_Club(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CHili_Club(const CHili_Club& rhs);
...
public:
	static CHili_Club*	Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
