...
HRESULT CLoader::Loading_Editor_Resources()
{
	...
	if (FAILED(m_pGameInstance->Add_Component_Prototype(LEVEL_EDITOR, TEXT("Prototype_Component_Texture_Particle"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../../Reference/Resources/Effect/Particle_%d.png"), 4))))
		return E_FAIL;
